...
class AddChallengeForm(forms.ModelForm) :
	...
	description = forms.CharField(max_length=1000, widget=forms.TextInput(attrs={'placeholder':'Challenge Description', 'class':'form-control'}), label="Challenge Description")
	...
	class Meta :
		...
		fields = ["name","category","description","points","flag","author"]